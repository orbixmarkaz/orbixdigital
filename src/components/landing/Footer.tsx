...
const footerLinks = [
  { title: "Services", links: ["Website Design", "Web Development", "E-Commerce", "SEO"] },
  { title: "Company", links: ["About Us", "Our Process", "Pricing", "Contact"] },
  { title: "Support", links: ["WhatsApp Support", "FAQs", "Privacy Policy", "Terms"] },
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm text-sm leading-relaxed">
              Professional website design and development for businesses that want
              a strong, reliable online presence. Based in Pakistan, serving clients worldwide.
            </p>
            <p className="text-muted-foreground mb-6 text-sm">
              <span className="font-semibold text-foreground">WhatsApp:</span>{" "}
              <a href="https://wa.me/923104431295" className="hover:text-primary transition-colors">
                +92 310 4431295
              </a>
            </p>
