         ...
         <div className="grid lg:grid-cols-2 gap-16 items-center">
           ...
           >
             <h2 className="text-3xl md:text-5xl font-bold mb-6">
              ...
              <span className="text-teal">Elevate Your Brand</span>
             </h2>
             ...
             <div className="relative aspect-square max-w-md mx-auto">
               ...
               <motion.div
                 ...
                 transition={{ duration: 20, repeat: Infinity, ease: "linear" }}
                  className="absolute inset-16 rounded-full border border-teal-light/20"
               />
 
               {/* Center Glow */}
                <div className="absolute inset-24 rounded-full bg-gradient-to-br from-teal/15 to-cyan/10 blur-2xl" />
               <div className="absolute inset-0 flex items-center justify-center">
                 <div className="text-center">
                   <div className="text-6xl font-bold gradient-text">360°</div>
                    <div className="text-navy-light mt-2">Digital Growth</div>
                 </div>
               </div>
               ...
               <motion.div
                 ...
                 transition={{ duration: 4, repeat: Infinity }}
                  className="absolute top-0 left-1/2 -translate-x-1/2 w-16 h-16 rounded-xl bg-white shadow-lg border border-border flex items-center justify-center"
               >
               ...
               <motion.div
                 ...
                 transition={{ duration: 5, repeat: Infinity }}
                  className="absolute bottom-0 left-1/2 -translate-x-1/2 w-16 h-16 rounded-xl bg-white shadow-lg border border-border flex items-center justify-center"
               >
               ...
               <motion.div
                 ...
                 transition={{ duration: 4.5, repeat: Infinity }}
                  className="absolute left-0 top-1/2 -translate-y-1/2 w-16 h-16 rounded-xl bg-white shadow-lg border border-border flex items-center justify-center"
               >
               ...
               <motion.div
                 ...
                 transition={{ duration: 5.5, repeat: Infinity }}
                  className="absolute right-0 top-1/2 -translate-y-1/2 w-16 h-16 rounded-xl bg-white shadow-lg border border-border flex items-center justify-center"
               >
